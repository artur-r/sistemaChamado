...
<body>
  ...
  <form action="finalizar_chamado.php?id=<?= $dados['id_chamado'] ?>" method="get">
    <div id="personal" style="width: 60%; margin-left: 30%;">
        <div class="mb-3">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" style="width: 100%;" name="resolucao"></textarea>
        </div>
